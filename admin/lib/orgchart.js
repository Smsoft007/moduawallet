    ...
    if (H) {
      ...
      if (_.length % 2) {
        ...
        OrgChart.templates[I] = {
          ...
          nodeMenuButton: "",
          size: S
        }, (q = new OrgChart.node(H.id + "_transperant", A.pid, [], I)).isAssistant = !0, o[q.id] = q, _.splice(_.length - 1, 0, q.id), OrgChart.server._initStates(q, o, t, a, e, m)
      }
      var N = 1;
